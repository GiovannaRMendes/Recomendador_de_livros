...
Diante destas perguntas, tem-se o [dashboard](Analise_dos_dados/analise_dos_dados.html).
...
<img src="Evidencias_criacao_configuracao/dashboard.png" width="50%" height="50%">