...
- recomendador de _livros_ com o uso de algoritmos de aprendizado de máquina;
- análise em cima do que os dados trazem sobre o consumo de _livros_ no *__Kindle da Amazon__* e *__Goodreads__*.
